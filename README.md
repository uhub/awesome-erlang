...
* [emqx/emqx](https://github.com/emqx/emqx) - EMQ X Broker - Massively Scalable MQTT Messaging Broker
...
* [lpil/gleam](https://github.com/lpil/gleam) - ✨ A well typed language that compiles to Erlang bytecode

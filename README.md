...
* [erlcloud/erlcloud](https://github.com/erlcloud/erlcloud) - Cloud Computing library for erlang (Amazon EC2, S3, SQS, SimpleDB, Mechanical Turk, ELB)
...
* [NetComposer/nkdist](https://github.com/NetComposer/nkdist) - Erlang distributed processes
...
* [wozniakjan/erlcart](https://github.com/wozniakjan/erlcart) - Erlang OpenShift Cartridge
...
* [yuce/pot](https://github.com/yuce/pot) - POT is an Erlang library for generating one time passwords compatible with Google Authenticator
...
* [markusn/coveralls-erl](https://github.com/markusn/coveralls-erl) - Erlang module to convert and send cover data to coveralls.io (or similar)

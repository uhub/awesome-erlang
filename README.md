...
* [emqx/emqtt](https://github.com/emqx/emqtt) - Erlang MQTT v5.0 Client
...
* [ostinelli/ram](https://github.com/ostinelli/ram) - An in-memory distributed KV store for Erlang and Elixir.
...
* [AbstractMachinesLab/caramel](https://github.com/AbstractMachinesLab/caramel) - :candy: An Erlang backend to the OCaml compiler
...
* [KristianPoslek/erlang-dht](https://github.com/KristianPoslek/erlang-dht) - A very simple example of implementing a structured P2P network (DHT) in Erlang.
* [project-fifo/eplugin](https://github.com/project-fifo/eplugin) - An erlang plugin manager

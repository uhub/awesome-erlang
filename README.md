...
* [ninenines/cowboy](https://github.com/ninenines/cowboy) - Small, fast, modular HTTP server written in Erlang.
...
* [rebar/rebar](https://github.com/rebar/rebar) - Erlang build tool that makes it easy to compile and test Erlang applications, port drivers and releases.
...
* [emqtt/emqttd](https://github.com/emqtt/emqttd) - Erlang MQTT Broker
...
* [esl/MongooseIM](https://github.com/esl/MongooseIM) - Jabber / XMPP server with focus on performance and scalability, by Erlang Solutions
...
* [lasp-lang/lasp](https://github.com/lasp-lang/lasp) - Prototype implementation of the Lasp language in Erlang.
...
* [basho/riak-erlang-client](https://github.com/basho/riak-erlang-client) - Erlang clients for Riak.
* [sockjs/sockjs-erlang](https://github.com/sockjs/sockjs-erlang) - WebSocket emulation - Erlang server
* [ninenines/gun](https://github.com/ninenines/gun) - Erlang HTTP client with support for HTTP/1.1, SPDY and Websocket.
...
* [yueyoum/make-proxy](https://github.com/yueyoum/make-proxy) - Socks5/HTTP proxy written in Erlang
...
* [jtendo/binpp](https://github.com/jtendo/binpp) - Erlang Binary Pretty Printer
...
* [chef/erchef](https://github.com/chef/erchef) - Erlang based Chef Server top-level OTP release project
...
* [ferd/vmstats](https://github.com/ferd/vmstats) - tiny Erlang app that works in conjunction with statsderl in order to generate information on the Erlang VM for graphite logs.
...
* [hntrmrrs/ewgi](https://github.com/hntrmrrs/ewgi) - Erlang web gateway interface: a standard interface between Erlang web servers and applications
...
* [SergejJurecko/erlmongo](https://github.com/SergejJurecko/erlmongo) - Record based Erlang driver for MongoDB with gridfs support
...
* [5HT/pie](https://github.com/5HT/pie) - Emacs written in Erlang
...
* [synrc/mad](https://github.com/synrc/mad) - Erlang Containers
...
* [ostinelli/syn](https://github.com/ostinelli/syn) - A global process registry for Erlang.
...
* [esl/escalus](https://github.com/esl/escalus) - An Erlang XMPP client library for conveniently testing XMPP servers
...
* [cabol/erlbus](https://github.com/cabol/erlbus) - Highly scalable pub/sub message bus written in Erlang
...
* [lpgauth/statsderl](https://github.com/lpgauth/statsderl) - StatsD client (erlang)
...
* [lpgauth/cassanderl](https://github.com/lpgauth/cassanderl) - Cassandra client (erlang)
...
* [klarna/brod](https://github.com/klarna/brod) - Client for Apache Kafka in Erlang
* [jeremey/swarm](https://github.com/jeremey/swarm) - Fast and simple acceptor pool for Erlang
* [inaka/erlang_training](https://github.com/inaka/erlang_training) - Excercises for people who're trying to learn Erlang
...
* [proger/erlfsmon](https://github.com/proger/erlfsmon) - Erlang filesystem event watcher for Linux and OSX
...
* [wagerlabs/ddb](https://github.com/wagerlabs/ddb) - Amazon DynamoDB API for Erlang
...
* [project-fifo/snarl](https://github.com/project-fifo/snarl) - A Erlang based RBAC server.
* [oinksoft/dtl](https://github.com/oinksoft/dtl) - Django Template Language: A full-featured port of the Django template engine to Erlang.
...
* [g-andrade/taskforce](https://github.com/g-andrade/taskforce) - Erlang worker pools for controlled parallelisation of arbitrary tasks.
...
* [vances/radierl](https://github.com/vances/radierl) - RADIUS protocol stack implemented in Erlang.
...
* [seancribbs/epb](https://github.com/seancribbs/epb) - Rage-driven Erlang Protocol Buffers rewrite
...
* [ndpar/erlang](https://github.com/ndpar/erlang) - Exercises from books "Erlang Programming" and "Programming Erlang", as well as other experiments in Erlang.
...
* [jj1bdx/tinymt-erlang](https://github.com/jj1bdx/tinymt-erlang) - Tiny Mersenne Twister (TinyMT) for Erlang
...
* [6/heroku-erlang-example](https://github.com/6/heroku-erlang-example) - erlang example using webmachine, hosted on heroku
...
* [lemenkov/eradius](https://github.com/lemenkov/eradius) - Erlang RADIUS library (originally taken from jungerl)
...
* [inaka/classifier](https://github.com/inaka/classifier) - An Erlang Bayesian Filter and Text Classifier
...
* [mafei198/game_server](https://github.com/mafei198/game_server) - Game Server Write In Erlang
* [lpgauth/swirl](https://github.com/lpgauth/swirl) - Lightweight distributed Erlang stream processor
...
* [archaelus/edbi](https://github.com/archaelus/edbi) - Database independent interface for Erlang
...
* [lpgauth/thrift-erlang](https://github.com/lpgauth/thrift-erlang) - Thrift client (erlang)
...
* [henry-hz/erlang-trader](https://github.com/henry-hz/erlang-trader) - Porting the AlgoTrader (Java) code to Erlang
...
* [jlouis/ecriterion](https://github.com/jlouis/ecriterion) - An Erlang-implementation of the Haskell Criterion benchmarking library
...
* [artemeff/eql](https://github.com/artemeff/eql) - Erlang with SQL
...
* [cabol/west](https://github.com/cabol/west) - WEST (Web/Event-driven Systems Tool) is another messaging tool written in Erlang, that enables the building of messaging-based systems, distributed systems.
...
* [2nth0nyj/ErlangGameServer](https://github.com/2nth0nyj/ErlangGameServer) - an erlang game server based on ranch, protocolbuf and riak.
...
* [sriramk/winazureerl](https://github.com/sriramk/winazureerl) - Erlang bindings for Windows Azure
...
* [inaka/elog](https://github.com/inaka/elog) - Yet another logging library for Erlang
* [inaka/eganglia](https://github.com/inaka/eganglia) - Erlang library to interact with Ganglia
...
* [erlio/vernemq](https://github.com/erlio/vernemq) - A distributed MQTT message broker
...
* [hibari/hibari](https://github.com/hibari/hibari) - Hibari is a production-ready, distributed, key-value, big data store. Hibari uses chain replication for strong consistency, high-availability, and durability. Hibari has excellent performance especially for read and large value operations.
...
* [skarab/ewgi](https://github.com/skarab/ewgi) - Erlang web gateway interface: a standard interface between Erlang web servers and applications
...
* [project-fifo/howl](https://github.com/project-fifo/howl) - Websocket based asynchronous message delivery.
...
* [yzh44yzh/erlang-school](https://github.com/yzh44yzh/erlang-school) - 3-х дневная программа обучения Erlang
